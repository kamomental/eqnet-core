...
@dataclass
class DiscussionThreadTraceRecord(BaseMemoryRecord):
    kind: str = "discussion_thread_trace"
    provenance: str = "inner_dialogue"
...
def normalize_memory_record(payload: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    elif kind == "discussion_thread_trace":
        record = DiscussionThreadTraceRecord(**kwargs)
