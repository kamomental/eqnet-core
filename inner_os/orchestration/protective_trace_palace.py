...
def derive_protective_trace_palace_state(
    ...
    *,
    ...
    stabilization_need = _clamp01(
        ...
        + sensory_flash_risk * 0.22
        + dream_intrusion_pressure * 0.14
        + somatic_reactivation * 0.2
        + (1.0 - field_clarity) * 0.14
    )
    ...
    if stabilization_need >= 0.58 and reentry_sensitivity >= 0.5:
        dominant_mode = "protective_hold"
    elif dream_intrusion_pressure >= 0.55 or sensory_flash_risk >= 0.62:
