...
class EmotionalHubRuntime:
    ...
    def step(
        ...
        intent:
            Intent label for the hub router (qa/chitchat/code遯ｶ・ｦ).
        fast_only:
    ...
    def _culture_behavior_hint(self, behavior: BehaviorMod) -> str:
        tone_hints = {
            "polite": "螢ｰ縺ｮ遶ｯ縲・ｒ蟆代＠荳∝ｯｧ縺ｫ縺励※縲∬ｨ縺・・繧翫ｂ蜥後ｉ縺偵※縺上□縺輔＞縲・,
            "casual": "閧ｩ縺ｮ蜉帙ｒ謚懊＞縺滓沐繧峨°縺・ｪ槫ｰｾ縺ｧ縲∬ｷ晞屬繧堤ｸｮ繧√ｋ繧医≧縺ｫ隧ｱ縺励※縺上□縺輔＞縲・,
            "neutral": "讓呎ｺ也噪縺ｪ隱槫ｰｾ縺ｧ關ｽ縺｡逹縺・◆繝医・繝ｳ繧剃ｿ昴▲縺ｦ縺上□縺輔＞縲・,
        }
        tone_line = tone_hints.get(behavior.tone, tone_hints["neutral"])
        empathy_line = (
            "豌玲戟縺｡縺ｮ閭梧勹繧剃ｸ蠎ｦ險縺・ｷｻ縺医ｋ縺ｨ螳牙ｿ・〒縺阪∪縺吶・
            if behavior.empathy_level >= 0.65
            else "蜈ｱ諢溘・荳險豺ｻ縺医ｋ遞句ｺｦ縺ｧ蜊∝・縺ｧ縺吶・
        )
        joke_line = (
            "霆ｽ縺・Θ繝ｼ繝｢繧｢繧・1 陦後□縺大ｷｮ縺苓ｾｼ繧薙〒繧ょ､ｧ荳亥､ｫ縲・
            if behavior.joke_ratio >= 0.4
            else "蜀苓ｫ・・謗ｧ縺医ａ縺ｫ縺励※縲∬誠縺｡逹縺・◆隱槭ｊ蜿｣縺ｫ縺励※縺上□縺輔＞縲・
        )
        return (
            f"[culture-field] {tone_line} {empathy_line} "
            f"Directness竕・behavior.directness:.2f}, joke_ratio竕・behavior.joke_ratio:.2f}. {joke_line}"
        )
